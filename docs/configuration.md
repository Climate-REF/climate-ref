...
Set it to `1` to fetch files sequentially, or reduce it when network bandwidth
or the remote server limits concurrent transfers.

The workers only download, copy, and verify files; they do not open NetCDF datasets.
